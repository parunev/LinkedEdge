...
@Operation(summary = "Get all user experiences", description = "GET endpoint to retrieve all experience entries associated with the user's profile. The user needs to be logged in order to do this.")
@ApiResponse(
        responseCode = "200",
...
public @interface ApiAllExperiences {
}
