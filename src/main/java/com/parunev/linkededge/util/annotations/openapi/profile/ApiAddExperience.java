...
@Operation(summary = "Adds user experience to the profile", description = "POST endpoint to add new experience entry to the user's profile. The user needs to be logged in order to do this.")
@ApiResponse(
        responseCode = "201",
        description = """
                Education entry added successfully. Response:
                You've successfully added a new experience to your profile
                Organisation: %s
                Description: %s
                Title: %s
                Location:%s
...
@ApiResponse(
        ...
        description = """
                ...
                1. The provided experience is not valid. (This validation might not work as expected as always since it's done via Gpt 3.5 Turbo model
...
public @interface ApiAddExperience {
}
